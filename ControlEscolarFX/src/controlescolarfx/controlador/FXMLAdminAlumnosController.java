...
public class FXMLAdminAlumnosController implements Initializable {
    ...
    private void clicBtnRegistrar(ActionEvent event) {
        try {
            Parent nuevaVistaFXML = FXMLLoader.load(ControlEscolarFX.class.getResource("vista/FXMLFormularioAlumno.fxml"));
            Scene newScene = new Scene(nuevaVistaFXML);
            
            Stage stageAdmin = new Stage();
            stageAdmin.setScene(newScene);
            stageAdmin.setTitle("Formulario de alumnos");
